...
export const Header = memo(
  ({ input, isLoading, systemMessageRef }: HeaderProps) => {
    const memoizedFaBars = useMemo(() => <FontAwesomeIcon icon={faBars} />, []);
    const memoizedFaRobot = useMemo(
      () => <FontAwesomeIcon icon={faRobot} />,
      []
    );

    const memoizedThemeChanger = useMemo(() => <ThemeChanger />, []);
